...
The server successfully detected this situation and will download merged part from the replica to force the byte-identical result.
    ...
    M(HTTPServerConnectionsPreserved, "Number of preserved server http connections. Connection keept alive successfully", ValueType::Number) \
    ...
    M(HTTPServerConnectionsReset, "Number of resetted server http connections. Server closes connection", ValueType::Number) \
    \
